...
# </xbar.var>
# <xbar.var>
#   boolean(VAR_SUBMENU_LAYOUT=true):
...
# </xbar.var-->
# <swiftbar.environment>[VAR_SUBMENU_LAYOUT=true,VAR_TABLE_RENDERING=true,VAR_DEFAULT_FONT=,VAR_MONOSPACE_FONT=font=Menlo size=12]</swiftbar.environment>
...
class MPMPlugin:
    ...
    def extended_environment() -> dict[str, str]:
        ...
        env_copy["PATH"] = ":".join(
            (
                ...
                "/opt/local/sbin",
                # pipx
                "/Users/pdelre/.local/pipx/venvs/meta-package-manager/bin",
                # System.
                os.environ.get("PATH", ""),
            ),
        )
    ...
    def print_menu(self) -> None:
        ...
        process = run(
            ...
            # section.
            # (*self.mpm_exec, "--verbosity", "CRITICAL", "managers"),
            (*self.mpm_exec, "--verbosity", "CRITICAL", "outdated", "--plugin-output"),
            capture_output=True,
            encoding="utf-8",
            env={
                "VAR_SUBMENU_LAYOUT": "true",
                "MPM_CONFIG": "/Users/pdelre/.mpm/config.yaml",
                "HOME": "/Users/pdelre",
                "PATH": "/Users/pdelre/.krew/bin:/Users/pdelre/.asdf/shims:/opt/homebrew/opt/asdf/libexec/bin:/opt/homebrew/bin:/usr/local/bin:/usr/local/sbin:/Users/pdelre/bin:/Users/pdelre/Library/Python/3.7/bin:/usr/local/opt/ruby/bin:/usr/local/opt/php@8.1/sbin:/usr/local/opt/php@8.1/bin:/opt/homebrew/opt/coreutils/libexec/gnubin:/opt/homebrew/sbin:/opt/homebrew/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Users/pdelre/Library/Application Support/JetBrains/Toolbox/scripts:/Users/pdelre/.dotfiles/bin:/opt/homebrew/opt/fzf/bin:/Users/pdelre/.local/bin:/Users/pdelre/.asdf/installs/golang/1.21.9/packages/bin",
            }
        )
        ...
        if (process.stderr or not process.stdout) and not process.stderr.startswith("Load configuration"):
        # if process.stderr or not process.stdout:
            ...
            # print("---")
            # print("Upgrade all | shell=\"(set -x; mpm upgrade --all && (brew outdated --cask --greedy-auto-updates | egrep -iv 'google-chrome' | xargs brew upgrade --cask) && mpm -m cask --include-auto-updates outdated && open -g 'swiftbar://refreshplugin?name=mpm.1h.py')\" terminal=true")

        print("---")
        print("Refresh | refresh=true shortcut=CMD+SHIFT+R")
