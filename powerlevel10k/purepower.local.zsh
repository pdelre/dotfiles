...
typeset -g POWERLEVEL9K_VCS_GIT_GITLAB_ICON=$'\uf296 ' #nf-fa-gitlab
typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON=$'\uf408 ' #nf-oct-mark_github
typeset -g POWERLEVEL9K_VCS_GIT_BITBUCKET_ICON=$'\uf171 ' #nf-fa-bitbucket
